...
def get_train_and_dev_dataset_loaders(args, train_data, dev_data, batch_size):
    ...
    for train_data and dev_data with distributed support
    '''
    # Check if we're using distributed training
    use_distributed = hasattr(args, 'train_sampler') and args.train_sampler is not None
    ...
    if use_distributed:
        ...
        train_data_loader = torch.utils.data.DataLoader(
            ...
            sampler=args.train_sampler,  # Use DistributedSampler
        ...
        dev_data_loader = torch.utils.data.DataLoader(
            dev_data,
            batch_size=batch_size,
            sampler=args.dev_sampler,  # Use DistributedSampler
            num_workers=args.num_workers,
            collate_fn=ignore_None_collate,
            pin_memory=True,
            drop_last=False
    ...
    elif args.class_bal or args.year_weighted_class_bal:
        # Original weighted sampling code
